    ...
    .then((info) => { 
      if (info.success == true) {
        ...
        setTimeout(
          ...
          window.location = '/product/purchase-return';
          }
          .bind(this),
          3000
        );
        ...
        <Card>
          <CardHeader>
            ...
            <Row>
              ...
              <Col md="6">
                  <Button color="success" onClick={this.toggleLarge} className="mr-1"> <i className="fa fa-plus-circle"></i> Add New Purchase Return</Button>
              </Col>
            </Row>
          </CardHeader>
          <CardBody>
