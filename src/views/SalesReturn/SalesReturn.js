    ...
    if ( event.target.value != '') {
      ...
      .then(sales => {
        ...
        while (i < sales.data.length) {
          ...
          productSalesObject.product_name_code = sales.data[i].bill_no;
        ...
        <Card>
          <CardBody>
            ...
            <Form action="" method="post" onSubmit={this.handleSubmit} onChange={this.handleProductChange} encType="multipart/form-data" className="form-horizontal">
              ...
              <FormGroup row>
                <Col md="3">
                  <Label htmlFor="pBillNo">Sales Bill No</Label>
                </Col>
                <Col xs="12" md="9">
                  <Input type="text" id="vendorWiseBillNoName" name="vendorWiseBillNoName" placeholder="Sales Bill No" required="true" ref='clear' onChange={this.handleAddChange.bind(this), this.searchBillNo.bind(this)} value={this.state.salesBillNoName} />
                </Col>
              </FormGroup>
